...
## Machine Context & Agent Feeds
- [Machine Context Index (`/llms.txt`)](https://arifcoskun.com/llms.txt)
- [Full Technical Profile (`/llms-full.txt`)](https://arifcoskun.com/llms-full.txt)
- [Agent Permissions Policy (`/agent-permissions.json`)](https://arifcoskun.com/agent-permissions.json)
- [Capability Skill Contract (`/skill.md`)](https://arifcoskun.com/skill.md)
- [Production Sitemap (`/sitemap.xml`)](https://arifcoskun.com/sitemap.xml)
